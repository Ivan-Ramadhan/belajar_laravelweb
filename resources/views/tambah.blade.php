			...
			<div class="card-body">
				...
				<br/>
				 ...
				 <table class="table table-borderless">
					...
					<form action="/laravelweb/public/pegawai/store" method="post">
					{{ csrf_field() }}
				...
				<tr>	
					...
					<td><input type="text" name="jabatan" required="required" > 
					</td>					
				<tr>
				...
				<tr>
					...
					<td><textarea name="alamat" required="required"></textarea> 
					</td>					
				</tr>
